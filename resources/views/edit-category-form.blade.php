...
<div class="content-wrapper">
    ...
    <form class="container-fluid d-flex flex-column align-items-center justify-content-center pt-5" action="{{ url("/admin/update-category/$category->id") }}" method="POST">
        @csrf
        @method('patch')
        ...
        <div style="width:500px; background-color: rgba(255,255,255,0.4);" class="border border-primary border-3 rounded p-5">
            ...
            <div class="form-group">
                <label for="name" class="text-primary mt-3">Edit Category Name</label>
