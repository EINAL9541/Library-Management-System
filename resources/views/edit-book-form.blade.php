...
<div class="content-wrapper">
    ...
    <form class="container-fluid d-flex flex-column align-items-center justify-content-center pt-5" action="{{ url("/admin/update-book/$book->id") }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('patch')
        ...
        <h4 class="text-primary mt-3">Image</h4>
        <img src="{{ '/storage/'.$book->image }}" width="80px" height="80px" alt="tt">
        <div class="form-group">
                <label for="image" class="text-primary mt-3">Image</label>
                <input type="file" class="form-control pt-1" id="image" name="image" value="{{$book->image}}">
                @if ($errors->has("image"))
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="category" name="category">
                    ...
                    @if (old('category') == $category->id || $book->category->name)
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="author" name="author">
                    ...
                    @if (old('author') == $author->id || $book->author->name)
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="summary" name="review" rows="3" >{{$book->review}}</textarea>
