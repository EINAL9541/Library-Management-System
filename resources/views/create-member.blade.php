...
<div class="content-wrapper">
    ...
    <form class="container-fluid d-flex flex-column align-items-center justify-content-center pt-5" action="{{route('create-member')}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('post')
